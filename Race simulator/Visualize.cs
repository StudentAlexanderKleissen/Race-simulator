...
namespace Race_simulator
{
    static class Visualize
    {
        ...
        public static void OnDriversChanged(object sender, DriversChangedEventArgs e)
        {
            ...
            //Console.WriteLine($"P1: {Player1.Equipment.IsBroken}");
            ...
            {
                Player1MovementSpeed = 2;
            }

            if (Player2MovementSpeed == 1)
            {
                Player2MovementSpeed = 2;
            }
            ...
            if (e.Track.Name == "Monaco" && Player1WentOverFinish <= NumberOfRounds || e.Track.Name == "Monaco" && Player2WentOverFinish <= NumberOfRounds)
            {
                ...
                if (Player1WentOverFinish <= NumberOfRounds && Player2.Equipment.IsBroken == false)
                {
                    ...
                    //Console.WriteLine($"Player 2 went over finish = {Player2WentOverFinish}");
                    if (Player1Direction == 0)
                    {
                        ...
                        //Player1Position[1]++;
                        if (Player1Position[0] > 108)
                        {
                            Player1Position[0] = 108;
                            Player1Position[1] += 1;
                        }
                        Console.SetCursorPosition(Player1Position[0], Player1Position[1]);
                ...
                else if (Player1WentOverFinish <= NumberOfRounds && Player1.Equipment.IsBroken == true)
                {
                    Console.SetCursorPosition(Player1Position[0], Player1Position[1]);
                    Console.WriteLine(Player1.Name.Substring(0, 1));
                }
                ...
                if (Player2WentOverFinish <= NumberOfRounds && Player2.Equipment.IsBroken == false)
                {
                    //Console.WriteLine($"{Player2WentOverFinish} Speler 2");
                    //Console.WriteLine($"Player 2 went over finish = {Player2WentOverFinish}");
                    if (Player2Direction == 0)
                    {
                        ...
                        //Player1Position[1]++;
                        if (Player2Position[0] > 103)
                        {
                            Player2Position[0] = 103;
                            //Player2Position[1] += 1;
                        }
                        Console.SetCursorPosition(Player2Position[0], Player2Position[1]);
                ...
                else if (Player2WentOverFinish <= NumberOfRounds && Player2.Equipment.IsBroken == true)
                {
                    Console.SetCursorPosition(Player2Position[0], Player2Position[1]);
                    Console.WriteLine(Player2.Name.Substring(0, 1));
                }
            ...
            if (e.Track.Name == "Zandvoort" && Player1WentOverFinish <= NumberOfRounds || e.Track.Name == "Zandvoort" && Player2WentOverFinish <= NumberOfRounds)
            {
                ...
                if ((Player1WentOverFinish <= NumberOfRounds && Player1.Equipment.IsBroken == false))
                {
            ...
            if(ShownScoreScreen == false && e.EveryoneHasFinished == false && Player1WentOverFinish > NumberOfRounds && Player2WentOverFinish > NumberOfRounds)
            {
                if (e.Track.Name == "Zandvoort")
                {
                    ZandvoortHasBeenRacedOn = true;
                }
                else if (e.Track.Name == "Monaco")
                {
                    MonacoHasBeenRacedOn = true;
                }
        ...
        public static void DrawFinishLine()
        {
        ...
        public static void OnStartNextRace(object sender, EventArgs e)
        {
            ...
            Data.NextRace();
            if (Data.CurrentRace != null && ZandvoortHasBeenRacedOn == false || Data.CurrentRace != null && MonacoHasBeenRacedOn == false)
            {
